...
/** The number of territories in the dataset. */
#define DATASET_TERRITORIES_AMOUNT 203

/** An alias for an array of characters long enough to contain a territory name. */
typedef char String[33];

/** The entry of a territory in the dataset. */
typedef struct Territory {
  /** The name of the territory. */
  String name;
  /** The base life expectancy in years. */
  double base_life_expectancy;
  /** The years of life lost from air pollution. */
  double air_pollution_yll;
  /** The years of life lost from ambient particular matter pollution. */
  double ambient_particulate_matter_pollution_yll;
  /** The years of life lost from ambient ozone pollution. */
  double ambient_ozone_pollution_yll;
  /** The years of life lost from household air pollution. */
  double household_air_pollution_yll;
  /** The years of life lost from environmental hazards. */
  double environmental_hazards_yll;
  /** The years of life lost from occupational hazards. */
  double occupational_hazards_yll;
  /** The years of life lost from unsafe water, sanitation, and health. */
  double unsafe_wash_yll;
  /** The years of life lost from metabolic syndrome. */
  double metabolic_syndrome_yll;
  /** The years of life lost from starvation. */
  double starvation_yll;
  /** The years of life lost from diabetes. */
  double diabetes_yll;
  /** The years of life lost from tobacco. */
  double tobacco_yll;
  /** The years of life lost from smoking. */
  double smoking_yll;
  /** The years of life lost from second hand smoking. */
  double second_hand_smoking_yll;
  /** The years of life lost from unsafe sex */
